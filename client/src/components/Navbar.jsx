  ...
  return (
    <nav className="bg-green-700 text-white shadow-lg">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        {/* Logo */}
        <Link to="/" className="flex items-center gap-2 text-xl font-bold hover:text-green-200 transition">
          🌿 GreenTrade
        </Link>
        ...
        {user && (
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <Link to="/dashboard" className="hover:text-green-200 transition-colors text-sm">
              Browse
            </Link>

            <Link to="/create-item" className="hover:text-green-200 transition-colors text-sm">
              + List Item
            </Link>

            <Link to="/my-items" className="hover:text-green-200 transition-colors text-sm">
              My Items
            </Link>

            <Link to="/leaderboard" className="hover:text-green-200 transition-colors text-sm">
              🏆 Leaderboard
            </Link>
            ...
            <div className="flex items-center gap-2 bg-green-800 rounded-full px-3 py-1">
              ...
              <span className="text-xs text-green-300">⭐ {user.greenPoints}</span>
            </div>
